                        ...
                        <div class="card main-bg rounded shadow-md p-3 hover-db">
                            <div class="row">
                                <div class="col-5 d-flex flex-column justify-content-center ">
                                    <div class="">
                                        <i class="fa-solid fa-ticket-simple fs-2 shadow rounded-circle p-3  text-center"></i>
                                    </div>
                                </div>
                                <div class="col-7">
                                    <div class="">
                    ...
                    <a href="{{ route('college') }}" class="nav-link  f-text pt-1">
                        <div class="card main-bg rounded shadow-md p-3 hover-db">
                            <div class="row">
                                <div class="col-5 d-flex flex-column justify-content-center ">
                                    <div class="">
                                        <i class="fa-solid fa-clipboard-check fs-2 shadow rounded-circle p-3  text-center"></i>
                                    </div>
                                </div>
                                <div class="col-7">
                                    <div class="">
                    ...
                    <a href="{{ route('courses') }}" class="nav-link  f-text pt-1">
                        <div class="card main-bg rounded shadow-md p-3 hover-db">
                            <div class="row">
                                <div class="col-5 d-flex flex-column justify-content-center ">
                                    <div class="">
                                        <i class="fa-solid fa-clipboard-list fs-2 shadow rounded-circle p-3  text-center"></i>
                                    </div>
                                </div>
                                <div class="col-7">
                                    <div class="">
                    ...
                    <a href="{{ route('evaluation') }}" class="nav-link  f-text pt-1">
                        <div class="card main-bg rounded shadow-md p-3 hover-db">
                            <div class="row">
                                <div class="col-5 d-flex flex-column justify-content-center ">
                                    <div class="">
                                        <i class="fa-solid fa-square-poll-vertical fs-2 shadow rounded-circle p-3  text-center"></i>
                                    </div>
                                </div>
                                <div class="col-7">
                                    <div class="">
                    ...
                    <a href="{{ route('records') }}" class="nav-link  f-text pt-1">
                        <div class="card main-bg rounded shadow-md p-3 hover-db">
                            <div class="row">
                                <div class="col-5 d-flex flex-column justify-content-center ">
                                    <div class="">
                                        <i class="fa-solid fa-clipboard-user fs-2 shadow rounded-circle p-3  text-center"></i>
                                    </div>
                                </div>
                                <div class="col-7">
                                    <div class="">
