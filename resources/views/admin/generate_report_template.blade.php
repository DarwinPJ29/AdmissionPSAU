...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="container mt-5">
            ...
            <div class="title text-center mb-3 text-upprcase">{{ $headers[0] }}</div>

            <div class="type">Applicatan type: <strong class="ms-2">{{ $headers[1] }}</strong></div>
            <div class="program">Program selected: <strong class="ms-2">{{ $headers[2] }}</strong></div>
            <div class="status">Status: <strong class="ms-2">{{ $headers[3] }}</strong></div>
            <div class="date">Date:  <strong class="ms-2">{{ $headers[4] }}</strong></div>
