...
<div class="border border-dark">
    <div class="row">
        ...
        <div class="col-md-3 border-end border-dark">
            <input type="text" name="father_fullname" id="father_fullname" class="form-control shadow m-1"
        ...
        <div class="col-md-3 border-end border-dark">
            <input type="text" name="mother_fullname" id="mother_fullname" class="form-control shadow m-1"
        ...
        <div class="col-md-3 ">
            <input type="text" name="guardian_fullname" id="guardian_fullname" class="form-control shadow m-1"
...
<div class="border border-dark">
    <div class="row">
        ...
        <div class="col-md-3 border-end border-dark">
            <input type="date" name="father_date_birth" id="father_date_birth" class="form-control shadow m-1"
        ...
        <div class="col-md-3 border-end border-dark">
            <input type="date" name="mother_date_birth" id="mother_date_birth" class="form-control shadow m-1"
        ...
        <div class="col-md-3 ">
            <input type="date" name="guardian_date_birth" id="guardian_date_birth" class="form-control shadow m-1"
...
<div class="border border-dark">
    <div class="row">
        ...
        <div class="col-md-3 border-end border-dark">
            <input type="text" name="father_education" id="father_education" class="form-control shadow m-1"
                placeholder="Enter Father's Educational Attainment" value="{{ old('father_education') }}">
            @error('father_education')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        <div class="col-md-3 border-end border-dark">
            <input type="text" name="mother_education" id="mother_education" class="form-control shadow m-1"
                placeholder="Enter Mother's Educational Attainment" value="{{ old('mother_education') }}">
            @error('mother_education')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        <div class="col-md-3 ">
            <input type="text" name="guardian_education" id="guardian_education" class="form-control shadow m-1"
                placeholder="Enter Guardian's Educational Attainment" value="{{ old('guardian_education') }}">
...
<div class="border border-dark">
    <div class="row">
        ...
        <div class="col-md-3 border-end border-dark">
            <input type="text" name="father_occupation" id="father_occupation" class="form-control shadow m-1"
        ...
        <div class="col-md-3 border-end border-dark">
            <input type="text" name="mother_occupation" id="mother_occupation" class="form-control shadow m-1"
        ...
        <div class="col-md-3 ">
            <input type="text" name="guardian_occupation" id="guardian_occupation"
                class="form-control shadow m-1" placeholder="Enter Guardian's Occupation/Employment"
...
<div class="border border-dark">
    <div class="row">
        ...
        <div class="col-md-3 border-end border-dark">
            <input type="text" name="father_company" id="father_company" class="form-control shadow m-1"
        ...
        <div class="col-md-3 border-end border-dark">
            <input type="text" name="mother_company" id="mother_company" class="form-control shadow m-1"
        ...
        <div class="col-md-3 ">
            <input type="text" name="guardian_company" id="guardian_company" class="form-control shadow m-1"
...
<div class="border border-dark">
    <div class="row">
        ...
        <div class="col-md-3 border-end border-dark">
            <input type="text" name="father_income" id="father_income" class="form-control shadow m-1"
        ...
        <div class="col-md-3 border-end border-dark">
            <input type="text" name="mother_income" id="mother_income" class="form-control shadow m-1"
        ...
        <div class="col-md-3 ">
            <input type="text" name="guardian_income" id="guardian_income" class="form-control shadow m-1"
...
<div class="border border-dark">
    <div class="row">
        ...
        <div class="col-md-3 border-end border-dark">
            <input type="text" name="father_contact" id="father_contact" class="form-control shadow m-1"
        ...
        <div class="col-md-3 border-end border-dark">
            <input type="text" name="mother_contact" id="mother_contact" class="form-control shadow m-1"
        ...
        <div class="col-md-3 ">
            <input type="text" name="guardian_contact" id="guardian_contact" class="form-control shadow m-1"
