        ...
        <div class="container">
            ...
            <div class="border border-dark p-2 rounded-bottom-1">
                ...
                <div class="row p-1 m-1 h-100">
                    <div class="col-md-4 border-end text-end d-flex flex-column justify-content-center"><label class="">Prefered Date of Enrolment</label></div>
                    <div class="col-md-4">
                        <label for="">School Year:</label>
                        <select name="school_year" id="school_year" class="form-select shadow @error('school_year') is-invalid @enderror"
