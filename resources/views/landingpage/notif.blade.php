    ...
    <div class="container-fluid ">
        <div class="d-flex flex-column justify-content-center">
            ...
            <div class="card mx-auto p-3 px-5 mt-5 shadow">
                ...
                <div class="fw-semibold text-center">Your Application was submitted <br> check your Email Address. <br>
                    Kindly check your spam folder if you don't see <br> the email in your
                    inbox</div>
