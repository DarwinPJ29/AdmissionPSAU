                    ...
                    <form action="{{ route('college.update', $college->id) }}" method="post"
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-7">
                                <label for="college_title">College Name <span class="text-danger">*</span></label>
                                <input type="text" name="college_title" id="department_college_title"
                                    class="form-control shadow" placeholder="Enter College Name:"
                                    value="{{ $college->title }}" required>
                            </div>
                            <div class="col-5">
                                <label for="college_acronym">Acronym <span class="text-danger">*</span></label>
                                <input type="text" name="college_acronym" id="college_acronym"
                                    class="form-control shadow" placeholder="Enter Acronym:"
                                    value="{{ $college->acronym }}" required>
...
{{-- delete --}}
@if (isset($college))
    <div class="modal fade" id="collegeDelete{{ $college->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header main-bg">
                ...
                <div class="modal-body border shadow">
                    <form action="{{ route('college.delete', $college->id) }}" method="post">
                        ...
                        <div class="mb-2 text-center fs-3">
                            ...
                            <span class="fw-bold text-uppercase">{{ $college->title }} - ({{ $college->acronym }})
                            </span> <br> College permanently ?
                        </div>
